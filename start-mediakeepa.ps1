...
$env:VIDEO_ENHANCER_CONTROL_PLANE_URL = "http://127.0.0.1:$ControlPlanePort"
$env:VIDEO_ENHANCER_CONTROL_PLANE_APPLICATION = "mediakeepa"
$env:VIDEO_ENHANCER_PREVIEW_WORKLOAD = "enhance-video-preview"
$env:VIDEO_ENHANCER_FULL_WORKLOAD = "enhance-video"
$env:VIDEO_ENHANCER_TIMEOUT_SECONDS = "86400"
